...
public class QnaServiceImpl implements QnaService {
    ...
    /**
     * 질문 상태를 답변완료("DONE")로 변경
     * - 현재 AdminAnswerServiceImpl.saveAnswer() 내부에서도 동일한 로직을 직접 호출하고 있어
     *   이 메서드가 실제로 사용되고 있는지 확인 필요 (중복 가능성)
     * @param qnaId 상태를 변경할 질문 ID
     */
    @Override
